...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Slide.public'
        db.add_column(u'mezzanine_slides_slide', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Slide.public'
        db.delete_column(u'mezzanine_slides_slide', 'public')
    ...
    models = {
        u'mezzanine_slides.slide': {
            ...
            'url': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'pages.page': {
